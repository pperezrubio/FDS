# -*- coding: utf-8 -*-
"""
Created on Mon Nov 03 15:07:32 2014
...
def create_lagged_series(symbol, start_date, end_date, lags=5):
    ...
    # Obtain stock information from Factset
   
    sd = start_date-datetime.timedelta(days=365)
    factlet = Factlet.ExtractFormulaHistory(symbol,"p_price_open,p_price_high,p_price_low,p_price,p_volume_frq",["dates",sd.strftime("%m/%d/%Y") + ":" + end_date.strftime("%m/%d/%Y")+":D"])
    ...
    data = pd.DataFrame(raw, columns=['Date','Open','High','Low','Adj Close','Volume'])
...
if __name__ == "__main__":
    ...
    snpret = create_lagged_series("AAPL", datetime.datetime(2001,1,10), datetime.datetime(2005,12,31), lags=5)
