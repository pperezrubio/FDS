...
def create_lagged_series(symbol, start_date, end_date, lags=5):
    ...
    factlet = Factlet.ExtractFormulaHistory("AAPL","p_price_open,p_price_high,p_price_low,p_price,p_volume_frq",["dates",sd.strftime("%m/%d/%Y") + ":" + end_date.strftime("%m/%d/%Y")+":D"])
