# -*- coding: utf-8 -*-
"""
Created on Wed Oct 29 15:00:01 2014
...
import numpy as np
import pandas as pd
from FactSetOnDemand import FactSetOnDemand, Factlet, UploadFactlet
import Quandl
...
if __name__ == "__main__":
    ...
    # on the command line)
    '''
    factlet = Factlet.ExtractFormulaHistory("7203-JP","p_price_open,p_price_high,p_price_low,p_price,p_volume_frq",["dates","20131006:20141014:D"])
    ...
    bars = data.set_index('Date')
    symbol = '7203-JP'
    
    '''
    symbol = 'SPY'
    bars = Quandl.get("GOOG/NYSE_%s" % symbol, collapse="daily", trim_start="2013-10-06", trim_end="2014-10-14")
